...
class PlotRouter:
    """
    This class controls Django's DB functionality to ensure that all plot models get routed to the plot DB
    """
    ...
    def allow_relation(self, model1: Type[Model], model2: Type[Model], **hints: Dict[str, Any]) -> Optional[bool]:
        ...
        """
        return True if model1._meta.app_label == 'plot' and model2._meta.app_label == 'plot' else None
    ...
    def allow_migrate(self, db: str, app_label: str, model_name: str = None, **hints: Dict[str, Any]) -> Optional[bool]:
        ...
        """
        return True if app_label == 'plot' and db == 'plot' else None
